...
from sklearn.decomposition import PCA #Este paquete se usa para verificar que el PCA se hizo de manera correcta
import os #Para poder usar bash en el codigo
...
#verificacion_cov(matriz_cov,matriz_numpy) #Si se quiere comprobar que la matriz esta bien, descomentar esta linea
